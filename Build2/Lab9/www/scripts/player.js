class Player {
    ...
    init(viewRange) {
        ...
        this.position = [window.innerWidth * 0.5, window.innerHeight * 0.8];
    ...
    move(touches) {
        ...
        // if the player  has reached the point  generate a new random location to walk to
    ...
    checkInRange(enemyPostion, enemyAlive) {
        if (enemyAlive == true) {
            ...
            if (this.enemyDistance[2] < this.viewRange * 2.42) {
